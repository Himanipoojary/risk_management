...
namespace DatabaseTool
{
    class Program
    {
        ...
        private const string RiskAdminServerConnectionString = "Server=localhost;Port=3306;Uid=root;Pwd=1978;AllowUserVariables=true;";
        //private const string DatabaseName = "risk_management_db";
        private const string DatabaseName = "erm_db";
